package com.github.redis.repository.impl;


import com.github.redis.properies.CacheHashKey;
import com.github.redis.properies.CacheKey;
 ...
 */
@Slf4j
public class RedisOpsImpl implements SuperBaseRedisOps {

    /**
     * Spring Redis Template
     */
    private final RedisUtils redisOps;

    public RedisOpsImpl(RedisUtils redisOps) {
